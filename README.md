...
| <a name="input_alb_ssl_certificate"></a> [alb\_ssl\_certificate](#input\_alb\_ssl\_certificate) | SSL certificate ARN for JSON-RPC loadblancer | `string` | `""` | no |
...
| <a name="input_enable_validators"></a> [enable\_validators](#input\_enable\_validators) | Toggles the Validator ASG | `bool` | `true` | no |
| <a name="input_genesis_path"></a> [genesis\_path](#input\_genesis\_path) | The path to the genesis | `string` | `""` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_alb"></a> [alb](#output\_alb) | The dns name for the JSON-RPC API |
...
| <a name="output_rpc_security_group_id"></a> [rpc\_security\_group\_id](#output\_rpc\_security\_group\_id) | The RPC security group id |
